...
/* IMPORTANT: Make sure your image file in src/assets/ is named 'logo.png' 
  and that you've cropped out the black frame if possible. 
  If not, the CSS below will help hide it.
*/
import julnarLogo from './assets/logo.jpg'; 
import { 
  FileText, 
  Phone, 
  MessageCircle, 
...
const App = () => {
  ...
  const userData = {
    fullNameEn: "Julnar Perfume",
    fullNameAr: "جلنار للعطور",
    phone: "+201067765409",
    whatsapp: "https://wa.me/201067765409",
    facebook: "https://www.facebook.com/share/1B1kvDcUzc/",
...
END:VCARD`;
  ...
  const content = {
    en: {
      name: "Julnar Perfume",
      role: "Luxury Fragrance House",
      skills: ["Exquisite Scents", "Premium Quality", "Global Shipping", "Personalized Collections"],
      resume: "VIEW CATALOG",
      saveBtn: "Save Contact",
      callBtn: "Direct Call",
      expertise: "OUR ESSENCE",
      status: "ONLINE NOW"
    },
    ar: {
      name: "جلنار للعطور",
      role: "دار العطور الفاخرة",
      skills: ["روائح رائعة", "جودة ممتازة", "شحن دولي", "مجموعات مخصصة"],
      resume: "عرض الكتالوج",
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          ...
          <div className="md:col-span-8 bg-[#111419] border border-white/5 rounded-[2.5rem] p-8 md:p-10 flex flex-col md:flex-row gap-8 items-center overflow-hidden">
            ...
            {/* Logo Container - Adjusted to hide the black frame */}
            <div className="w-32 h-32 bg-[#0a0c10] rounded-2xl flex items-center justify-center overflow-hidden shadow-lg shrink-0 border border-white/10 relative">
              <img
                src={julnarLogo} 
                alt="Julnar Perfume"
                className="w-full h-full object-cover scale-110" // scale-110 helps crop out the edge frames
              />
            </div>
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <a href={userData.facebook} target="_blank" rel="noreferrer" className="flex items-center justify-center p-5 bg-[#161a20] border border-white/5 rounded-[1.8rem] hover:bg-white/5 transition-all text-white/70 hover:text-white">
                <Facebook size={22} />
              </a>
              <a href={userData.instagram} target="_blank" rel="noreferrer" className="flex items-center justify-center p-5 bg-[#161a20] border border-white/5 rounded-[1.8rem] hover:bg-white/5 transition-all text-white/70 hover:text-white">
                <Instagram size={22} />
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-4 bg-[#111419] border border-white/5 rounded-[2.5rem] p-8">
            ...
            <div className="flex flex-col gap-2.5">
              {t.skills.map((skill) => (
                <div key={skill} className="px-5 py-3.5 bg-[#161a20] border border-white/5 rounded-xl text-[11px] font-semibold text-gray-300 transition-colors">
                  {skill}
                </div>
              ))}
            </div>
          ...
          <div className="md:col-span-6 bg-white rounded-[2.5rem] flex flex-col items-center justify-center p-10 hover:bg-gray-200 transition-all cursor-pointer group shadow-2xl">
          ...
          <div className="md:col-span-2 bg-[#161a20] rounded-[2.5rem] flex items-center justify-center hover:bg-[#25D366]/10 transition-all cursor-pointer group border border-white/5">
